...
;(function (window, document, undefined) {
    ...
    var wechatQrcodeHelperDesc = title.split('|')[0].trim();
    if (wechatQrcodeHelperDesc.length > 35) {
        wechatQrcodeHelperDesc = wechatQrcodeHelperDesc.substring(0, 35) + '...';
    }
    wechatQrcodeHelperDesc = '<p>' + wechatQrcodeHelperDesc + '</p>';
    ...
    var defaults = {
        ...
        wechatQrcodeHelper: wechatQrcodeHelperDesc,
    ...
    function createWechat (elem, data) {
        ...
        var size = data.wechatQrcodeSize * data.wechatQrcodeSize;
        jQuery(qrcode[0]).qrcode({
            render: 'canvas',
            minVersion: 10,
            maxVersion: 40,
            ecLevel: 'H',
